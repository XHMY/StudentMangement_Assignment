...
public class textOfTable extends JTextPane{
	...
	public textOfTable(Color backcolor,String startTime,String times) {
		...
		this.setEditable(false);//设置无法编辑
		
		//设置第一行文本样式
		SimpleAttributeSet font1 = new SimpleAttributeSet();//创建样式变量
		StyleConstants.setForeground(font1, Color.black);//设置文本颜色
		StyleConstants.setFontSize(font1, 12);//设置文本字体大小
		StyleConstants.setAlignment(font1, StyleConstants.ALIGN_CENTER);//设置文本居中显示
		...
		StyleConstants.setBold(font2, true);//设置字体加粗
