 ...
 * key-value pairs in the symbol table. The <em>size</em>, and <em>is-empty</em>
 * operations take &Theta;(1) time. The <em>keys</em> methods take
 * <em>O</em>(log <em>n</em> + <em>m</em>) time, where <em>m</em> is the number
 * of keys returned by the iterator. Construction takes &Theta;(1) time.
 * <p>
